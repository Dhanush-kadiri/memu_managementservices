...
import owner2 from '../images/santhosh.jpg'
    ...
    <div className="about-us-container">
        ...
        <p>
          What is this, you ask? Well, let me tell you about MEMU - the event management company that's
           here to make your events as memorable as a politician's promise. Imagine a world where your birthday party doesn't
            feel like a hostage situation, and your corporate gala doesn't resemble a funeral with better snacks. That's where MEMU 
            comes in, armed with a sense of humor and a deep understanding that event planning should be fun, not a form of torture.
             ...
             MEMU is here to ensure your event is the talk of the town - in a good way, not the "did you hear about the caterer who set the
              venue on fire?" kind of way. So, what are you waiting for? Let MEMU take the stress out of event planning and turn your soiree 
      ...
      >
        ...
        <div className="owner-info">
          ...
          <p>
            Meet Santhosh - CO-Founder of MEMU. With an unparalleled enthusiasm for event management, 
            ...
            memorable is what sets MEMU apart. Together, they form a dynamic duo committed to turning your special moments into lifelong memories.
          </p>
        </div>
      </motion.div>
